...
namespace FitnessStore.Controllers
{
    public class ClassTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ClassTypeID,SelectClass,Description")] ClassType classType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClassTypeID,SelectClass,Description")] ClassType classType)
        {
            if (ModelState.IsValid)
            {
